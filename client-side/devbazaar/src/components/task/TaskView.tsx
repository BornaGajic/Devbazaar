...
const TaskView = observer(({ task } : { task: Task }) => {
    ...
    return (
        <div>
            <div className="card">
                <div className="card-header py-3 px-4" id="headingOne">
                    <h2 className="mb-0">
                        <button className="d-flex align-items-center justify-content-between btn" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            ...
                            <div className="col text-start">
                                ...
                                <span className="fs-6">{ task.username }</span>
                            </div>
