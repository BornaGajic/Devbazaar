...
const Header = ({}) => 
{
    return (
        ...
        <input className="mx-3  form-control form-control-dark shadow-none me-2" type="text" placeholder="Search" aria-label="Search"/>
        ...
        <div id="advancedSearch" className="dropdown-menu w-100 bg-dark">
          ...
          <div className="list-group-item bg-dark" style={{color : 'white'}}>
            <div className="form-check form-switch">
              ...
              <input className="form-check-input" type="checkbox" id="ascUsernameCheckbox" style={{height : 25, width : 50}}/>
            </div>
          </div>
